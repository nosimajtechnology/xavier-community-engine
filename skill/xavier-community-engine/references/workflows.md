...
3. Verify PS2 grounding when visual fidelity is relevant.
4. Write a compact Scene Lock.
5. Create the Genesis Frame prompt or image.
6. Run identity, render, premise, continuity, and rights QA.
...
Diagnose before changing anything. Preserve approved identity, framing, geography, and unaffected beats. Repair only the failed layer. If an entire render stack is modern, preserve composition/action and rebuild materials, light, environment density, and capture limits together.
