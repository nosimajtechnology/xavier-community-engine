...
3. Attach the canonical identity asset; attach the leg authority whenever Xavier's legs are visible.
4. Verify PS2 grounding when visual fidelity is relevant.
5. Write a compact Scene Lock, including the exact leg rig when visible.
6. Create the Genesis Frame prompt or image.
7. Run identity, anatomy, render, premise, continuity, and rights QA.
8. Ask for Genesis Frame approval for multi-shot work.
9. Build connected boards or a motion brief after approval.
10. Ask for storyboard approval before provider-specific compression.
11. Deliver the final prompt package.
...
Lock Xavier's orientation, scene geography, opening action, camera, rendering sources and roles, palette/time, supporting subjects/props, must-not-change constraints, crop safety, and leg construction when visible.
