...
- Long blond hair with crude, broad clumps and the approved silhouette.
- Dark-brown furred body and deliberately awkward, asymmetric proportions.
- Yellow bird-like beak in place of a human nose or animal muzzle.
- Anatomical right eye: bright cyan-blue. Anatomical left eye: brown.
- Anatomical left forearm and hand: bright-green snake from the elbow downward. The snake is anatomy, not a pet or prop.
- Anatomical right hand: ordinary black-gloved hand.
...
## Leg construction lock

Each leg has exactly:

1. one thigh
2. one true knee joint
3. one lower leg
4. one ankle
5. one normal flat white human sneaker

The single knee alone hinges backward. Both legs share the same reversed-knee rig. These are plantigrade two-segment legs, not animal or bird hocks.

- strict side profile: the knee is the clear rearward apex behind the hip-to-ankle axis
- three-quarter view: the same backward hinge remains visible but restrained
- front or back view: the legs may appear nearly straight; never add a forward human knee to make the pose readable

Reject standard forward-bending human knees, digitigrade hocks, a second bend, extra segments, elongated feet, S-curves, bowed/hooked/rubber-hose legs, exaggerated reverse curvature, mismatched left/right rigs, or changed shoes.

## Optional prop

The shakashuri is optional and must come from a supplied or verified reference when identity-sensitive. Keep it separate from Xavier's body and snake arm. Do not invent its exact construction from memory.
