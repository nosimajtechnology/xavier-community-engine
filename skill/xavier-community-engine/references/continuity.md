...
- visible leg angle: side, three-quarter, front, back, or occluded
- environment map, landmarks, camera side, and screen direction
- Xavier's goal and current misunderstanding
- supporting identities, positions, and reactions
...
When the legs are visible, record for each shot:

- inherited approved frame or authority asset
- camera view of the legs
- whether the backward hinge is directly readable or naturally subtle
- confirmation that no forward human knee, animal hock, extra segment, or mismatched left/right rig appeared

Side and three-quarter views must preserve a readable backward hinge. Front and back views may appear nearly straight. Do not exaggerate or invent a forward knee. If the legs are fully occluded, preserve the rig without forcing it into the composition.
...
```text
LOCK:
[passing identity, framing, geography, action, lighting, and rendering]

CHANGE ONLY:
[one failed layer]

DO NOT CHANGE:
[every approved or passing layer]
```
